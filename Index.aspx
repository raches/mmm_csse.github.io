<%@ Page Title="" Language="C#" MasterPageFile="~/csse_Master.master" AutoEventWireup="true" CodeFile="Index.aspx.cs" Inherits="Index" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="maincon1" Runat="Server">
	...
	<!-------------------MODAL IMAGE--------------------->
        <a target="_blank" href="./logo/msg.png">
            <img id="ms" src="./logo/msg.png" alt="Message from the desk of President" width="200" height="200">
        </a>
	<p><strong><span style="color: #FF6666;">Click to see the image in new window.</span></strong></p>
</asp:Content>


<asp:Content ID="Content3" ContentPlaceHolderID="maincon3" Runat="Server">
...
<asp:Content ID="Content2" ContentPlaceHolderID="maincon2" Runat="Server">
    <div id="nt" style="text-align:center;background-color:cadetblue;">
            <h2 class="nttitle" style="padding:10px 0 10px 0;">Notice</h2><hr />
             </div>

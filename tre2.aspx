<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tre2.aspx.cs" Inherits="rec1" %>
...
<body>
    ...
    <div id="w1">
      &emsp;&emsp;<span style="color:black;">Welcome To Treasury Departememt</span>
        ...
        <br />
    <center>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="None" AllowSorting="True" BorderStyle="None" Caption="Second Year  Record" CaptionAlign="Top" CssClass="grid1" BackColor="#666666" ShowFooter="True" Width="662px" CellSpacing="1">
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [record2]" DeleteCommand="DELETE FROM [record2] WHERE [Id] = @Id" InsertCommand="INSERT INTO [record2] ([Id], [Name], [Roll_No], [Status]) VALUES (@Id, @Name, @Roll_No, @Status)" UpdateCommand="UPDATE [record2] SET [Name] = @Name, [Roll_No] = @Roll_No, [Status] = @Status WHERE [Id] = @Id">
            <DeleteParameters>

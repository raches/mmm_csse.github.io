<%@ Page Language="C#" AutoEventWireup="true" CodeFile="tre3.aspx.cs" Inherits="rec1" %>
    ...
    <form id="form1" runat="server" method="post">
     <div id="w1">
       &emsp;&emsp;<span style="color:black;">Welcome To Treasury Departememt</span>
        ...
        <br />
    <center>
        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CellPadding="3" DataKeyNames="Id" DataSourceID="SqlDataSource1" GridLines="None" AllowSorting="True" BorderStyle="None" Caption="Third Year  Record" CaptionAlign="Top" CssClass="grid1" BackColor="#666666" ShowFooter="True" Width="662px" CellSpacing="1" ForeColor="Black">
        ...
        <br />
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:DBCS %>" SelectCommand="SELECT * FROM [record3]" DeleteCommand="DELETE FROM [record3] WHERE [Id] = @Id" InsertCommand="INSERT INTO [record3] ([Id], [Name], [Roll_No], [Status]) VALUES (@Id, @Name, @Roll_No, @Status)" UpdateCommand="UPDATE [record3] SET [Name] = @Name, [Roll_No] = @Roll_No, [Status] = @Status WHERE [Id] = @Id">
            <DeleteParameters>

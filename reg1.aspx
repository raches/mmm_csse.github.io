<%@ Page Title="" Language="C#" MasterPageFile="~/csse_Master.master" AutoEventWireup="true" CodeFile="reg1.aspx.cs" Inherits="login_forms_tlogin" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="maincon1" Runat="Server">
    ...
    <center>
            <div class="logform">
                <asp:Label ID="Label1" runat="server" Text="Create New Treasurer of CSSE"></asp:Label>
